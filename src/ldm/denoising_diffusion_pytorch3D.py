...
from dataset_npy import DatasetNpy

# constants
# Creates a lightweight, immutable data structure (similar to a tuple) with named fields.
    ...
    def __init__(
        ...
        *,
        ...
        if npy_filepath is not None:
            # dataset and dataloader
            self.ds = DatasetNpy(npy_filepath)
            dl = DataLoader(self.ds, batch_size = train_batch_size, shuffle = True, pin_memory = True, num_workers = 4)
